...
class CubePrimitive(object):
    ...
    def __init__(self):
        ...
        self.color = foxglove_msgs.Color()
    ...
    def decode(data: bytes):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != CubePrimitive._get_packed_fingerprint():
    ...
    def _get_packed_fingerprint():
        ...
        return CubePrimitive._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", CubePrimitive._get_packed_fingerprint())[0]
